...
public:
    ...
    void set_polling_mode_select(select::Select *sel);
...
private:
    ...
    friend class TeslaPollingModeSelect;
};
...
// =============================================================================
// Polling Mode Select — HA-controlled adaptive polling
// =============================================================================

class TeslaPollingModeSelect : public select::Select {
public:
    void set_parent(TeslaBLEVehicle *parent) { parent_ = parent; }
...
protected:
    ...
    TeslaBLEVehicle *parent_{nullptr};
    std::string initial_option_{"lazy"};
};
